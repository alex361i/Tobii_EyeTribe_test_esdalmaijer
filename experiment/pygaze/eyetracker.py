...
class EyeTracker(BaseEyeTracker):
    ...
    def __init__(self, display, trackertype=settings.TRACKERTYPE, **args):
        ...
        **args        --    A keyword-argument dictionary that contains
        ...
        # correct wrong input
        if trackertype not in [u'dumbdummy', u'dummy', u'eyelink', u'smi', u'tobii', u'eyetribe', u'opengaze',u'tobii4c',u'tobii4ctesting']:
            raise Exception( \
        ...
        # Tobii4c
        elif trackertype == u'tobii4c':
            # import libraries
            from pygaze._eyetracker.libtobii4c import TobiiTracker
            # morph class
            self.__class__ = TobiiTracker
            # initialize
            self.__class__.__init__(self, display, **args)
        ...
        # Tobii4ctesting
        elif trackertype == u'tobii4ctesting':
            # import libraries
            from pygaze._eyetracker.tobii4ctesting import TobiiTracker
            # morph class
            self.__class__ = TobiiTracker
            # initialize
            self.__class__.__init__(self, display, **args)
