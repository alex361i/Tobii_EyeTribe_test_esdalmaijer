...
EXCL = ['Alin_tobii','Anca4c_TOBII_output','George4c_TOBII_output','Giulia4c_TOBII_output','Robert4c_TOBII_output','Robert']
...
OUTDIR = os.path.join(IOUTDIR, 'group_data_eyetribe')
...
for ppname in PPS:
	...
	cmdlist = ["python", "analysis_v2_eyetribe.py", ppname]
