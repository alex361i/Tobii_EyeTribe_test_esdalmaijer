...
read_data = {'tobii4c':read_tobii4c,'eyetribe':read_eyetribe}
...
for trackertype in ['tobii4c','eyetribe']:    
    ...
    if trackertype == 'tobii4c':
        DATAFILE = os.path.join(DATADIR, '%s_tobii.tsv' % PPNAME)
