...
#EXCL = ['AN2_tobii','AN2','AX','AX2','JA','PR','tobiiAA','tobiiBB','tobiiCC','yingchao','yingchao_tobii','alex_tobii']
EXCL = ['Alin_Eyetribe','Anca_Eyetribe','George_Eyetribe','Giulia_Eyetribe','Robert_Eyetribe','George','Giulia']
# settings
...
OUTDIR = os.path.join(IOUTDIR, 'group_data_tobii4c')
...
for ppname in PPS:
	...
	cmdlist = ["python", "analysis_v2_tobii4c.py", ppname]
